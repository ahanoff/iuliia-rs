...
//!
//! See: <https://dangry.ru/iuliia/scientific/>
...
impl Schema for Scientific {
    const NAME: &'static str = "scientific";
...
mod tests {
    ...
    fn test_sample_0() {
        assert_eq!(
            Scientific::transliterate("Юлия, съешь ещё этих мягких французских булок из Йошкар-Олы, да выпей алтайского чаю"),
