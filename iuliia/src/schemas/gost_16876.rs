...
/// GOST 16876-71 (aka GOST 1983) transliteration schema.
pub struct Gost16876;

impl Schema for Gost16876 {
    const NAME: &'static str = "gost_16876";
...
mod tests {
    ...
    fn test_sample_0() {
        assert_eq!(
            Gost16876::transliterate("Юлия, съешь ещё этих мягких французских булок из Йошкар-Олы, да выпей алтайского чаю"),
